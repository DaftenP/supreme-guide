...
const nextSlide = () => {
  ...
  // console.log(images.value[currentIndex.value]);
...
<template>
  <div class="relative">
    <div class="slider-container mt-8">
      <div class="slider">
        <div class="frame absolute inset-0 flex justify-center items-center">
          <img
...
<style scoped>
.frame {
  border: 20px solid #fff; /* 액자 스타일의 테두리 */
